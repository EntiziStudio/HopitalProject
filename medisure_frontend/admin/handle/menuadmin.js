...
async function loadMenu(){
  ...
  '<li class="nav-item">'+
    '<a class="nav-link" href="doctor.html"><i class="fa fa-user-md"></i><span class="menu-title">Bác sĩ</span></a>'+
  '</li>'+
  '<li class="nav-item">'+
  ...
  '</li>'+
  '<li class="nav-item">'+
    '<a class="nav-link" href="process.html"><i class="fa fa-cogs"></i><span class="menu-title">Medical Process</span></a>'+
  '</li>'+
  '<li class="nav-item nav-category">Profile</li>'+
  '<li class="nav-item">'+
    '<a class="nav-link" href="profile.html"><i class="fa fa-edit"></i><span class="menu-title">Profile</span></a>'+
  '</li>'+
  '<li class="nav-item">'+
